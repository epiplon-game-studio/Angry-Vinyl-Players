...
namespace UnityStandardAssets.Characters.FirstPerson
{
	...
	public class FirstPersonController : MonoBehaviour
	{
		...
		private void Start()
		{
			...
			m_waterLayer = LayerMask.GetMask("Water");
		...
		private void Walk()
		{
			...
			var walk = m_Input.y * m_CharacterController.transform.TransformDirection(Vector3.forward);
			var strafe = m_Input.x * m_CharacterController.transform.TransformDirection(Vector3.right);
			Vector3 desiredMove = (walk + strafe);
		...
		protected void ProgressStepCycle(float speed)
		{
			...
			{
				m_StepCycle += (m_CharacterController.velocity.magnitude + (speed * m_RunstepLenghten)) * Time.deltaTime;
			}
		...
		private void OnGUI()
		{
			GUI.Label(new Rect(0, 0, 200, 50), "Direction: " + m_MoveDir);
		}
	}
}
